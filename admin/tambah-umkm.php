...
$page_title = 'Tambah UMKM Baru';
$topbar_title = 'Tambah UMKM';
...
<div id="main-content">
  <div class="page-content">
    <div class="page-header d-flex align-items-center justify-content-between flex-wrap gap-2">
      <div>
        <h1 class="page-title"><i class="fas fa-plus-circle me-2"></i> Tambah UMKM Baru</h1>
        <p class="page-subtitle">Masukkan detail informasi UMKM utama</p>
      </div>
    ...
    <div class="card">
      <div class="card-body p-4">
        <form action="proses_umkm/tambah-umkm.php" method="POST" class="needs-validation" novalidate>
          <div class="row g-4">
            <!-- Informasi Dasar -->
            ...
            <div class="col-12 mt-5 text-end">
              <button type="submit" class="btn btn-primary px-4 py-2"><i class="fas fa-save me-2"></i> Simpan UMKM</button>
            </div>
          </div>
        </form>
      </div>
